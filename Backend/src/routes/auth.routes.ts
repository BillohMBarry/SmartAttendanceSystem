...
import { loginSchema, registerSchema, employeeSignupSchema, updateProfileSchema } from '../utils/validation.js';
...
router.post('/signup', authLimiter, validate(employeeSignupSchema), authController.employeeSignup);
